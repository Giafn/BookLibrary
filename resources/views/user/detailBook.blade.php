...
<div class="container ms-2">
    <ul class="breadcrumb">
        ...
        <li><a href="#"><small>{{$data->title}}</small></a></li>
    </ul>
    @if (session('success'))
            ...
            <div class="modal-body">
                ...
                <form id="formBorrow" action="{{url('/borrow/'.$data->id)}}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="return_date" name="date_return" min="{{date('Y-m-d', strtotime('+1 days'))}}" max="{{date('Y-m-d', strtotime('+30 days'))}}">
